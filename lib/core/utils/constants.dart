...
abstract class Constants {
  ...
  static const String appDesc =
      ...
      'يحتوي التطبيق أيضًا على مكتبة ضخمة من الأحاديث النبوية، حيث يمكنك قراءة العديد من أنواع الأحاديث واختيار الأنسب لك. بالإضافة إلى ذلك، يضم مجموعة من الأذكار اليومية التي يمكنك تكرارها مع إمكانية تتبع التقدم.\n\n'
